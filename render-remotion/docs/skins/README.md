...
15 verified skins for the Remotion free-compose path. A skin is **tokens only**
...
| ![pop-sticker](13-pop-sticker.png) `pop-sticker`: playful mass-market, TikTok/Reels | ![handcraft-marker](15-handcraft-marker.png) `handcraft-marker`: reflective wisdom, business ethics, hand-drawn storytelling | |
